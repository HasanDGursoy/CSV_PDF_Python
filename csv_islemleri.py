...
Virgül ve Noktalı Virgül ile ayrılmış değerler tutar
"""
# Python'da CVS okuma işlemleri --> csv paketi ile yapılır
...
def csv_oku():
    with open(film_yolu, 'r') as dosya:
        ...
        # csv.reader() geriye bir iterator döner --> üzerinde döngü kurulabilir.
        for film in filmler:
            # her bir satır bir film , bir list olarak dönecek
            print(film)
...
def csv_oku_dilect():
    ...
    with open(film_yolu, 'r') as dosya:
        fimler = csv.reader(dosya, dialect='normal_okuma')
        for film in fimler:
            print(film)
...
eklenecek_film = ["250", "Slumdog Millionaire", "2008", "R", "25 Dec 2008", "120 min", "Drama",
                  "Danny Boyle, Loveleen Tandan", "Simon Beaufoy (screenplay), Vikas Swarup (novel)",
                  ...
                  "Internet Movie Database", "8.0/10", "86", "8.0", "679,975", "tt1010048", "movie", "N/A", "N/A",
                  "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A",
                  "http://www.rottentomatoes.com/m/slumdog_millionaire/", "31 Mar 2009", "$141,243,551",
                  "Fox Searchlight Pictures",
                  "http://www.foxsearchlight.com/slumdogmillionaire/", "True"
                  ]
...
# Aynı anda 2 dosyada işlem nasıl yapabiliriz.
def csv_kopyala():
    yeni_film_yolu = 'data/movies_csv_kopya.csv'

    # yeni dosyayı yaratalım
